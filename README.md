...
* iESBM_benchmark: data of iESBM, include datasets, features and FER results, see [data/in]();
...
The iESBM benchmark can be used to evaluate any general-purpose entity summarizer through the following process:
 ...
 * <code>-feature_name</code> is optional and its values include: 'LFoP', 'GFoP', 'GFoV', 'IoPV', 'DoP' and 'DoV'.
...
Open [f_imp.py](), add a new <code>elif</code> statement to the function <code>get_feature_by_name()</code>:
<pre>
elif fname=='${fname}'
...
Then, open [f_imp.py](), add a new <code>elif</code>-statement to function <code>get_feature_by_name()</code>, to return an object of the newly defined class:
<pre>
elif fname=='${fname}'
